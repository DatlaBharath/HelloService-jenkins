...
"""
                    ...
                    sh 'ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@52.66.211.13 "kubectl apply -f -" < deployment.yaml'
                    sh 'ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@52.66.211.13 "kubectl apply -f -" < service.yaml'
                }
            }
        }
    }
